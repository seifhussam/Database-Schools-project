...
$q = "SELECT * FROM Schools where iD = (SELECT school_iD from Employees where username = '$adminuname' )"; 
                         ...
                         <tr>
                            ...
                            <?php 
                                ...
                                ?>
                                    ...
                                    <div class="col-md-4">
                        <a href="http://localhost/MS4/bs-twopage/updateSchoolValues.php" class="btn btn-success">Update</a>
                    </div>       
                 <!-- /. ROW  -->
                  <hr />
