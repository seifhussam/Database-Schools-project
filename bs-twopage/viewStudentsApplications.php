...
$q = "SELECT * FROM Parents_ApplyAt_Schools_for_Students where school_iD ='$schooliD' "; 
                         ...
                         <tr>
                            ...
                            <?php 
                                ...
                                ?>
                                    ...
                                    <div class="col-md-4">
                        <a href="http://localhost/MS4/bs-twopage/acceptRejectAStudent.php" class="btn btn-success">Review an Application</a>
                    </div>           
                 <!-- /. ROW  -->
                  <hr />
